...
public class PizzaWorker {
  public static void main(String[] args) {
    ...
    // 4. Register the new activity implementation class with the worker
    worker.registerActivitiesImplementations(new PizzaActivitiesImpl(), new LocalPizzaActivitiesImpl());
